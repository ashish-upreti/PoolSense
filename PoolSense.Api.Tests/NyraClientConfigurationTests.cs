...
public sealed class NyraClientConfigurationTests
{
    ...
    [Fact]
    public void NyraClientSecretSettings_BindExpectedDefaults()
    {
    ...
    [Fact]
    public async Task NyraClientCredentials_ShouldCallResponsesEndpoint()
    {
    ...
    [Fact]
    public async Task NyraClientCredentials_ShouldGenerateEmbedding()
    {
        var settings = CreateSettings(requireSecret: true);
        if (settings is null)
        {
        ...
        request.Content = JsonContent.Create(new
        {
            ...
            texts = new[] { "PoolSense NYRA client credential embedding smoke test." },
